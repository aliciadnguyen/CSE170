    ...
    .directive('d3Bar', ['d3', function(d3) {
      return {
        ...
        link: function(scope, iElement, iAttrs) {
			...
			//to be moved to JSON
			var dataset = [ 10, 15, 20, 25, 20, 14, 9];
